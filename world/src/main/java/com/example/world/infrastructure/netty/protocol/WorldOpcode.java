...
public enum WorldOpcode {
    ...
    C_MSG_PLAYER_LOGIN(0x03D),
    S_MSG_UPDATE_OBJECT(0x0A9),
    S_MSG_INITIALIZE_FACTIONS(0x122),
    S_MSG_ACTION_BUTTONS(0x129),
    S_MSG_INITIAL_SPELLS(0x12A),
    S_MSG_INIT_WORLD_STATES(0x2C2),
    S_MSG_LOGIN_VERIFY_WORLD(0x236),
    S_MSG_TUTORIAL_FLAGS(0x0FD),
    S_MSG_ACCOUNT_DATA_TIMES(0x209),
    S_MSG_LOGIN_SETTIMESPEED(0x042),
    C_MSG_PING(0x1DC),
    S_MSG_PONG(0x1DD);
